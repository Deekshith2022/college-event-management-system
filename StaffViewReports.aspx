<%@ Page Title="" Language="C#" MasterPageFile="~/StaffMasterPage.master" AutoEventWireup="true" CodeFile="StaffViewReports.aspx.cs" Inherits="StaffViewReports" %>
...
<asp:HyperLinkField DataNavigateUrlFields="SelectedId" 
                DataNavigateUrlFormatString="StaffUpdateStatus.aspx?selectedid={0}" 
                HeaderText="Update Status" Text="Update Status" />

                <asp:HyperLinkField DataNavigateUrlFields="SelectedId" 
                DataNavigateUrlFormatString="StaffViewDetails.aspx?selectedid={0}" 
