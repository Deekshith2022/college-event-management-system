<%@ Page Title="" Language="C#" MasterPageFile="~/CommomMasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <section id="hero" class="d-flex flex-column justify-content-end align-items-center">
    ...
    <img src="assets/img/testimonials/college%20image.jpg" alt="" class="img-fluid">
      <!-- Slide 1 -->
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">NCB Events</h2>
          <p class="animate__animated fanimate__adeInUp">Welcome to The National Degree College Basavanagudi Events Website</p>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">NCB Events</h2>
          <p class="animate__animated animate__fadeInUp">Here you can browse and register to numerous number of events which take place in our college campus </p>          
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">NCB Events</h2>
          <p class="animate__animated animate__fadeInUp">NCB have other world for students to explore except the studies we call it Events </p>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <p class="fst-italic">
                  ...
                  <br />
                  While Students tend to work on the overall event concept,Professors deal with the details of its execution.
                </p>
                <ul>
